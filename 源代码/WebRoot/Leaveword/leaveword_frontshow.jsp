...
<div class="container">
	...
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">老师解答:</div>
		<div class="col-md-10 col-xs-6"><%=leaveword.getReplyContent()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">解答老师:</div>
		<div class="col-md-10 col-xs-6"><%=leaveword.getTeacherNo()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">解答时间:</div>
