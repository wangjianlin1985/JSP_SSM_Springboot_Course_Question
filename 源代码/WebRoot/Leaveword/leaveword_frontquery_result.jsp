...
<%
    ...
    String teacherNo = (String)request.getAttribute("teacherNo"); //解答老师查询关键字
%>
<!DOCTYPE html>
<html>
<head>
...
<jsp:include page="../header.jsp"></jsp:include>
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>留言id</td><td>留言标题</td><td>留言人</td><td>留言时间</td><td>老师解答</td><td>解答老师</td><td>解答时间</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="leavewordQueryForm" id="leavewordQueryForm" action="<%=basePath %>Leaveword/frontlist" class="mar_t15" method="post">
			...
			<div class="form-group">
				<label for="teacherNo">解答老师:</label>
				<input type="text" id="teacherNo" name="teacherNo" value="<%=teacherNo %>" class="form-control" placeholder="请输入解答老师">
			</div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="leaveword_replyContent_edit" class="col-md-3 text-right">老师解答:</label>
		  	 <div class="col-md-9">
			    <textarea id="leaveword_replyContent_edit" name="leaveword.replyContent" rows="8" class="form-control" placeholder="请输入老师解答"></textarea>
			 </div>
		  </div>
		  <div class="form-group">
		  	 <label for="leaveword_teacherNo_edit" class="col-md-3 text-right">解答老师:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="leaveword_teacherNo_edit" name="leaveword.teacherNo" class="form-control" placeholder="请输入解答老师">
			 </div>
		  </div>
		  <div class="form-group">
		  	 <label for="leaveword_replyTime_edit" class="col-md-3 text-right">解答时间:</label>
		  	 <div class="col-md-9">
                <div class="input-group date leaveword_replyTime_edit col-md-12" data-link-field="leaveword_replyTime_edit">
                    <input class="form-control" id="leaveword_replyTime_edit" name="leaveword.replyTime" size="16" type="text" value="" placeholder="请选择解答时间" readonly>
                    <span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
                    <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
                </div>
		  	 </div>
	...
	$.ajax({
		...
		success : function (leaveword, response, status) {
			if (leaveword) {
				...
				$("#leaveword_teacherNo_edit").val(leaveword.teacherNo);
