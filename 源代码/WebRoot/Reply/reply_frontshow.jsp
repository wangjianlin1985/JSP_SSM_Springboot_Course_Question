...
<div class="container">
	<ul class="breadcrumb">
  		...
  		<li><a href="<%=basePath %>Reply/frontlist">问题解答信息</a></li>
  		<li class="active">详情查看</li>
	</ul>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">回答id:</div>
		<div class="col-md-10 col-xs-6"><%=reply.getReplyId()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">被回问题:</div>
		<div class="col-md-10 col-xs-6"><%=reply.getPostInfoObj().getTitle() %></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">回答内容:</div>
		<div class="col-md-10 col-xs-6"><%=reply.getContent()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">回答人:</div>
		<div class="col-md-10 col-xs-6"><%=reply.getUserObj().getName() %></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">回答时间:</div>
