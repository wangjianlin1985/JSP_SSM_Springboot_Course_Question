...
<%
    ...
    String replyTime = (String)request.getAttribute("replyTime"); //回答时间查询关键字
%>
<!DOCTYPE html>
<html>
<head>
		...
		<div class="col-md-9 wow fadeInDown" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	...
			    	<li role="presentation" class="active"><a href="#replyListPanel" aria-controls="replyListPanel" role="tab" data-toggle="tab">问题解答列表</a></li>
			    	<li role="presentation" ><a href="<%=basePath %>Reply/reply_frontAdd.jsp" style="display:none;">添加问题解答</a></li>
				</ul>
			  	<!-- Tab panes -->
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>回答id</td><td>被回问题</td><td>回答内容</td><td>回答人</td><td>回答时间</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
				    	            		...
				    	            		for(int i=0;i<replyList.size();i++) {
					    	            		...
					    	            		Reply reply = replyList.get(i); //获取到问题解答对象
 										%>
 										<tr>
 											<td><%=currentIndex %></td>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="replyQueryForm" id="replyQueryForm" action="<%=basePath %>Reply/frontlist" class="mar_t15" method="post">
            <div class="form-group">
            	<label for="postInfoObj_postInfoId">被回问题：</label>
            ...
            <div class="form-group">
            	<label for="userObj_user_name">回答人：</label>
			...
			<div class="form-group">
				<label for="replyTime">回答时间:</label>
				<input type="text" id="replyTime" name="replyTime" class="form-control"  placeholder="请选择回答时间" value="<%=replyTime %>" onclick="SelectDate(this,'yyyy-MM-dd')" />
			</div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><i class="fa fa-edit"></i>&nbsp;问题解答信息编辑</h4>
      </div>
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
			 <label for="reply_replyId_edit" class="col-md-3 text-right">回答id:</label>
			 <div class="col-md-9"> 
			 	<input type="text" id="reply_replyId_edit" name="reply.replyId" class="form-control" placeholder="请输入回答id" readOnly>
			 </div>
		  </div> 
		  <div class="form-group">
		  	 <label for="reply_postInfoObj_postInfoId_edit" class="col-md-3 text-right">被回问题:</label>
		  	 <div class="col-md-9">
		  ...
		  <div class="form-group">
		  	 <label for="reply_content_edit" class="col-md-3 text-right">回答内容:</label>
		  	 <div class="col-md-9">
			    <textarea id="reply_content_edit" name="reply.content" rows="8" class="form-control" placeholder="请输入回答内容"></textarea>
			 </div>
		  </div>
		  <div class="form-group">
		  	 <label for="reply_userObj_user_name_edit" class="col-md-3 text-right">回答人:</label>
		  	 <div class="col-md-9">
		  ...
		  <div class="form-group">
		  	 <label for="reply_replyTime_edit" class="col-md-3 text-right">回答时间:</label>
		  	 <div class="col-md-9">
                <div class="input-group date reply_replyTime_edit col-md-12" data-link-field="reply_replyTime_edit">
                    <input class="form-control" id="reply_replyTime_edit" name="reply.replyTime" size="16" type="text" value="" placeholder="请选择回答时间" readonly>
