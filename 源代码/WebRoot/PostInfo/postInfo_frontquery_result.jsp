		...
		<div class="col-md-9 wow fadeInDown" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	...
			    	<li role="presentation" class="active"><a href="#postInfoListPanel" aria-controls="postInfoListPanel" role="tab" data-toggle="tab">学生问答列表</a></li>
			    	<li role="presentation" ><a href="<%=basePath %>PostInfo/postInfo_frontAdd.jsp" style="display:none;">添加学生问答</a></li>
				</ul>
			  	<!-- Tab panes -->
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>问题id</td><td>问题标题</td><td>浏览量</td><td>提问人</td><td>提问时间</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
				    	            		...
				    	            		for(int i=0;i<postInfoList.size();i++) {
					    	            		...
					    	            		PostInfo postInfo = postInfoList.get(i); //获取到学生问答对象
 										%>
 										<tr>
 											<td><%=currentIndex %></td>
  ...
  <div class="modal-dialog" style="width:900px;" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><i class="fa fa-edit"></i>&nbsp;学生问答信息编辑</h4>
      </div>
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
			 <label for="postInfo_postInfoId_edit" class="col-md-3 text-right">问题id:</label>
			 <div class="col-md-9"> 
			 	<input type="text" id="postInfo_postInfoId_edit" name="postInfo.postInfoId" class="form-control" placeholder="请输入问题id" readOnly>
			 </div>
		  </div> 
		  <div class="form-group">
		  	 <label for="postInfo_title_edit" class="col-md-3 text-right">问题标题:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="postInfo_title_edit" name="postInfo.title" class="form-control" placeholder="请输入问题标题">
			 </div>
		  </div>
		  <div class="form-group">
		  	 <label for="postInfo_content_edit" class="col-md-3 text-right">问题内容:</label>
		  	 <div class="col-md-9">
		  ...
		  <div class="form-group">
		  	 <label for="postInfo_userObj_user_name_edit" class="col-md-3 text-right">提问人:</label>
		  	 <div class="col-md-9">
		  ...
		  <div class="form-group">
		  	 <label for="postInfo_addTime_edit" class="col-md-3 text-right">提问时间:</label>
		  	 <div class="col-md-9">
                <div class="input-group date postInfo_addTime_edit col-md-12" data-link-field="postInfo_addTime_edit">
                    <input class="form-control" id="postInfo_addTime_edit" name="postInfo.addTime" size="16" type="text" value="" placeholder="请选择提问时间" readonly>
...
<script>
//实例化编辑器
var postInfo_content_edit = UE.getEditor('postInfo_content_edit'); //问题内容编辑器
