	...
	<div class="col-md-9 wow fadeInLeft">
		...
		<div class="row">
			...
			<div class="col-md-3 bottom15" <%=clearLeft %>>
			  <a  href="<%=basePath  %>Teacher/<%=teacher.getTeacherNo() %>/frontshow"><img class="img-responsive" src="<%=basePath%><%=teacher.getUserPhoto()%>" /></a>
  ...
  <div class="modal-dialog" style="width:900px;" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="teacher_userPhoto_edit" class="col-md-3 text-right">教师照片:</label>
		  	 <div class="col-md-9">
			    <img  class="img-responsive" id="teacher_userPhotoImg" border="0px"/><br/>
			    <input type="hidden" id="teacher_userPhoto" name="teacher.userPhoto"/>
	...
	$.ajax({
		...
		success : function (teacher, response, status) {
			if (teacher) {
				...
				$("#teacher_userPhoto").val(teacher.userPhoto);
				$("#teacher_userPhotoImg").attr("src", basePath +　teacher.userPhoto);
