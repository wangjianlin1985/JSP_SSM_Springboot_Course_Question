...
<div class="container">
	<ul class="breadcrumb">
  		...
  		<li><a href="<%=basePath %>Teacher/frontlist">老师信息</a></li>
	...
	<div class="row bottom15"> 
		...
		<div class="col-md-10 col-xs-6"><img class="img-responsive" src="<%=basePath %><%=teacher.getUserPhoto() %>"  border="0px"/></div>
	</div>
	<div class="row bottom15"> 
	...
	<div class="row bottom15"> 
		...
		<div class="col-md-10 col-xs-6"><%=teacher.getEmail()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">家庭地址:</div>
		<div class="col-md-10 col-xs-6"><%=teacher.getAddress()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">教师简介:</div>
