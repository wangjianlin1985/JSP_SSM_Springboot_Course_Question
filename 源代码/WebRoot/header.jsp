...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">课程答疑网</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>Reply/frontlist">问题解答</a></li>
                <li><a href="<%=basePath %>CourseApply/frontlist">课程申请</a></li>-->
                <li><a href="<%=basePath %>Teacher/frontlist">老师风采</a></li>
                <li><a href="<%=basePath %>Course/frontlist">课程查询</a></li>
                
                <li><a href="<%=basePath %>PostInfo/frontlist">学生问答</a></li>
                
                <li><a href="<%=basePath %>Leaveword/frontlist">提问老师</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        <li><a href="<%=basePath %>CourseApply/userFrontlist"><span class="glyphicon glyphicon-screenshot"></span>&nbsp;&nbsp;我的课程申请</a></li>
                        <li><a href="<%=basePath %>PostInfo/postInfo_userFrontAdd.jsp"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;我要提问</a></li>
                        <li><a href="<%=basePath %>PostInfo/userFrontlist"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;我发布的问题</a></li>
                        <li><a href="<%=basePath %>Reply/userFrontlist"><span class="glyphicon glyphicon-heart"></span>&nbsp;&nbsp;我的解答记录</a></li>
                        <li><a href="<%=basePath %>Leaveword/leaveword_userFrontAdd.jsp"><span class="glyphicon glyphicon-credit-card"></span>&nbsp;&nbsp;给老师提问</a></li>
