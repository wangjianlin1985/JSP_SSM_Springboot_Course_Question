...
public class TeacherService {
    ...
    /*按照查询条件分页查询老师记录*/
    public ArrayList<Teacher> queryTeacher(String teacherNo,String name,String birthDate,String telephone,int currentPage) throws Exception { 
    ...
    /*按照查询条件查询所有记录*/
    public ArrayList<Teacher> queryTeacher(String teacherNo,String name,String birthDate,String telephone) throws Exception  { 
     	String where = "where 1=1";
    	if(!teacherNo.equals("")) where = where + " and t_teacher.teacherNo like '%" + teacherNo + "%'";
    	if(!name.equals("")) where = where + " and t_teacher.name like '%" + name + "%'";
    	if(!birthDate.equals("")) where = where + " and t_teacher.birthDate like '%" + birthDate + "%'";
    ...
    /*当前查询条件下计算总的页数和记录数*/
    public void queryTotalPageAndRecordNumber(String teacherNo,String name,String birthDate,String telephone) throws Exception {
     	String where = "where 1=1";
    	if(!teacherNo.equals("")) where = where + " and t_teacher.teacherNo like '%" + teacherNo + "%'";
    	if(!name.equals("")) where = where + " and t_teacher.name like '%" + name + "%'";
    	if(!birthDate.equals("")) where = where + " and t_teacher.birthDate like '%" + birthDate + "%'";
