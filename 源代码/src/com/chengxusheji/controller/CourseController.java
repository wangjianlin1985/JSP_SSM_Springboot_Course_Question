...
public class CourseController extends BaseController {
	...
	public void teacherAdd(Course course, BindingResult br,
		...
		teacherObj.setTeacherNo(session.getAttribute("teacherNo").toString());
	...
	public void OutToExcel(String courseNo,String courseName,@ModelAttribute("teacherObj") Teacher teacherObj, Model model, HttpServletRequest request,HttpServletResponse response) throws Exception {
        ...
        String[] headers = { "课程编号","课程名称","总学时","课程学分","上课教室","上课老师"};
        List<String[]> dataset = new ArrayList<String[]>(); 
        for(int i=0;i<courseList.size();i++) {
        	Course course = courseList.get(i); 
        	dataset.add(new String[]{course.getCourseNo(),course.getCourseName(),course.getCourseHours() + "",course.getCourseScore() + "",course.getCoursePlace(),course.getTeacherObj().getName()});
        }
        /*
